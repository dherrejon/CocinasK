...
{   
    ...
    {
        GetContrato($http, $q, CONFIG, $rootScope.personaId).then(function(data)
        {
    ...
    //------------- Vista -----------------------------
    $scope.CambiarContratoDetalle = function(contrato)
    {
        if($scope.contratoDetalle == contrato.ContratoId)
        {
            $scope.contratoDetalle = "";
        }
        else
