app.controller("RecuperarPasswordControlador", function($scope, $window, $rootScope, $http, CONFIG, datosUsuario, datosPerfil, $routeParams, $q, md5)
{   
    ...
    if($scope.usuarioLogeado !== null)
    {
        ...
        {
            if($scope.usuarioLogeado.PerfilSeleccionado == "Administrador" || $scope.usuarioLogeado.PerfilSeleccionado == "Operativo" || $scope.usuarioLogeado.PerfilSeleccionado == "Ejecutivo")
            {
