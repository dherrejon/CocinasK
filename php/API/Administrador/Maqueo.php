...
function GetGrupoMaqueo($id)
{
    ...
    $sql = "SELECT GrupoPorColorId, GrupoId, ColorId, Nombre, Activo FROM GrupoColorCubiertaVista WHERE GrupoId = 
            (SELECT GrupoId FROM Maqueo WHERE MaqueoId = '".$id."')";
